...
export const GraphQLContactNameInput = new GraphQLInputObjectType({
...
export const GraphQLContactInput = new GraphQLInputObjectType({
  name: "ContactInput",
  fields: () => fields
});

export const GraphQLContactInitialInput = new GraphQLInputObjectType({
  name: "ContactInitialInput",
  fields: () => ({
    ...fields,
    displayName: {
      ...fields.displayName,
      type: new GraphQLNonNull(fields.displayName.type)
    }
  })
});
