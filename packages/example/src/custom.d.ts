// The graphiql library imports these, which are missing definitions. Quickly declaring them
// as `any` doesn't have any adverse impact on our use, and allows us to move forward.
