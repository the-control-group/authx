import { GraphQLID, GraphQLInt, GraphQLNonNull, GraphQLString, GraphQLList, GraphQLBoolean, GraphQLObjectType, } from "graphql";
import { GraphQLAuthority, GraphQLNode } from "@authx/authx";
...
export const GraphQLEmailAuthority = new GraphQLObjectType({
    ...
    isTypeOf: (value) => value instanceof EmailAuthority,
    fields: () => ({
...
//# sourceMappingURL=GraphQLEmailAuthority.js.map