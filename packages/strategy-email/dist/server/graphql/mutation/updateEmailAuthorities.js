...
export const updateEmailAuthorities = {
    type: new GraphQLList(GraphQLEmailAuthority),
    description: "Update a new authority.",
    args: {
        authorities: {
            type: new GraphQLNonNull(new GraphQLList(new GraphQLNonNull(GraphQLUpdateEmailAuthorityInput))),
        },
    },
        ...
        const results = args.authorities.map(async (input) => {
            ...
            try {
                ...
                if (!(before instanceof EmailAuthority)) {
                    throw new NotFoundError("The authority uses a strategy other than email.");
                }
                ...
                const authority = await EmailAuthority.write(tx, {
                    ...before,
                    ...
                    description: typeof input.description === "string"
                        ...
                        : before.description,
                    details: {
                        privateKey: typeof input.privateKey === "string"
                            ? input.privateKey
                            : before.details.privateKey,
                        publicKeys,
                        proofValidityDuration: typeof input.proofValidityDuration === "number"
                            ? input.proofValidityDuration
                            : before.details.proofValidityDuration,
                        authenticationEmailSubject: typeof input.authenticationEmailSubject === "string"
                            ? input.authenticationEmailSubject
                            : before.details.authenticationEmailSubject,
                        authenticationEmailText: typeof input.authenticationEmailText === "string"
                            ? input.authenticationEmailText
                            : before.details.authenticationEmailText,
                        authenticationEmailHtml: typeof input.authenticationEmailHtml === "string"
                            ? input.authenticationEmailHtml
                            : before.details.authenticationEmailHtml,
                        verificationEmailSubject: typeof input.verificationEmailSubject === "string"
                            ? input.verificationEmailSubject
                            : before.details.verificationEmailSubject,
                        verificationEmailText: typeof input.verificationEmailText === "string"
                            ? input.verificationEmailText
                            : before.details.verificationEmailText,
                        verificationEmailHtml: typeof input.verificationEmailHtml === "string"
...
//# sourceMappingURL=updateEmailAuthorities.js.map