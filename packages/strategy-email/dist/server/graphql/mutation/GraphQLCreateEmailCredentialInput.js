...
export const GraphQLCreateEmailCredentialInput = new GraphQLInputObjectType({
    ...
    fields: () => ({
        ...
        authorityId: {
            type: new GraphQLNonNull(GraphQLID),
            description: "The ID of the AuthX email authority that can verify this credential.",
        },
        email: {
            type: new GraphQLNonNull(GraphQLID),
        ...
        proof: {
            type: GraphQLString,
            description: "This is a unique code that was sent by the authority to prove control of the email address.",
        },
        administration: {
...
//# sourceMappingURL=GraphQLCreateEmailCredentialInput.js.map