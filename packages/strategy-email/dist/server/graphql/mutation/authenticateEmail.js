...
import { v4 } from "uuid";
import { GraphQLAuthorization, Authority, Authorization, ForbiddenError, AuthenticationError, User, DataLoaderExecutor, } from "@authx/authx";
    ...
    async resolve(source, args, context) {
        ...
        try {
            ...
            if (!(authority instanceof EmailAuthority)) {
                throw new AuthenticationError(__DEV__
            ...
            if (!credential) {
                throw new AuthenticationError(__DEV__ ? "No such credential exists." : undefined);
            }
            ...
            // The user needs to be sent a proof.
                ...
                await sendMail({
                    ...
                    text: substitute({ proof, url }, authority.details.authenticationEmailText),
                    html: substitute({ proof, url }, authority.details.authenticationEmailHtml),
                });
...
//# sourceMappingURL=authenticateEmail.js.map