...
export const createEmailAuthorities = {
    type: new GraphQLList(GraphQLEmailAuthority),
    description: "Create a new email authority.",
    args: {
        authorities: {
            type: new GraphQLNonNull(new GraphQLList(new GraphQLNonNull(GraphQLCreateEmailAuthorityInput))),
        },
    },
...
//# sourceMappingURL=createEmailAuthorities.js.map