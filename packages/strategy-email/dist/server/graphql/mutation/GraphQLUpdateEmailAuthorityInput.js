...
export const GraphQLUpdateEmailAuthorityInput = new GraphQLInputObjectType({
    ...
    fields: () => ({
        ...
        addPublicKeys: {
            ...
            description: "Add a key to the list of RS512 public keys that will be used to verify the proofs sent to verify ownership of email addresses. This allows private keys to be rotated without invalidating current proofs.",
        },
        removePublicKeys: {
            type: new GraphQLList(new GraphQLNonNull(GraphQLString)),
            description: "Remove a key from the list of RS512 public keys that will be used to verify the proofs sent to verify ownership of email addresses.",
        },
...
//# sourceMappingURL=GraphQLUpdateEmailAuthorityInput.js.map